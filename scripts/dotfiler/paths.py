...
executables.append("/opt/local/Library/Frameworks/Python.framework/Versions/2.7/bin")
executables.append("/opt/local/Library/Frameworks/Python.framework/Versions/3.4/bin")
